...
Every request is inspected for PII automatically. The routing strategy (`anonymize` vs `edge`) is configured at the API key level on the Worker — not in the SDK.
